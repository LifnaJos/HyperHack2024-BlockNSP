...
// import OrganizationRegistrationForm from "./components/Scholarship/OrganizationRegistartionForm";
// import StudentFormDesign from "./components/Scholarship/StudentFormDesign";
        ...
        <div>
            {loading ? (
                ...
                <Routes>
                    ...
                    {/* <Route path="/organization-registration" element={OrganizationRegistrationForm}></Route>
                    <Route path="/student-registration-form" element={StudentFormDesign}></Route> */}
                </Routes>
            )}
        </div>
    );
